...
import com.mingYang.G03_Thread.impl.MyThread03;

/**
 * 设置线程名称的两种方式：
 *      1. void setName(String name)  改变线程名称，使之与参数 name 相同。
 *      2.创建一个带参数的构造方法，参数传递线程的名称；调用父类的带参构造方法，把线程名称传递给父类，让父类（G03_Thread）给子线程起一个名字
 *          G03_Thread(String name)  分配新的 G03_Thread 对象。
 */
