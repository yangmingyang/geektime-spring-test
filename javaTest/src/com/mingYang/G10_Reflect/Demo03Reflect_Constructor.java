...
public class Demo03Reflect_Constructor {
    ...
    public void getConstructorTest() throws IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchMethodException {
        ...
        //java.lang.NoSuchMethodException: com.mingYang.G10_Reflect.domain.Person.<init>(java.lang.Integer, java.lang.String)如果构造方法是私有的，则会报这个错误
    ...
    public void getConstructorsTest(){
        ...
        for (Constructor<Person> c:  constructors){
             ...
             *  public com.mingYang.G10_Reflect.domain.Person()
             *  public com.mingYang.G10_Reflect.domain.Person(java.lang.Integer,java.lang.String)
             */
        }
    }
    ...
    public void getDeclaredConstructorsTest(){
        ...
        for (Constructor<Person> c : declaredConstructors){
            ...
            /**
             * 获取的结果：把所有的构造方法都获取到了
             * public com.mingYang.G10_Reflect.domain.Person(java.lang.String)
             * private com.mingYang.G10_Reflect.domain.Person(java.lang.Integer,java.lang.String)
             * public com.mingYang.G10_Reflect.domain.Person()
             */
        }
    }
